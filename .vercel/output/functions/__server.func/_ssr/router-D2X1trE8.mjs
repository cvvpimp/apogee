...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D2X1trE8.js
var router_D2X1trE8_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DiJNdHIN.css";
var APP_NAME = "White Stoop";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Two cartoon shooters play street dice on a blank white curb — Cee-lo, back and forth."
			},
			{
				name: "theme-color",
				content: "#ffffff"
...
var $$splitComponentImporter = () => import("./routes-DrzqidK2.mjs");
...
//#endregion
export { getRouter, router_D2X1trE8_exports as t };
